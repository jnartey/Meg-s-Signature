		...
		<div class="large-10 columns content">
			...
			?>
				<tr>
					<td>
						<?php 
							$category =  AppController::getParent('Category', 'id', $product['Product']['category_id']);
					...
					<td class="actions">
						...
						<?php 
							if($category['Category']['status'] == 1){
								echo $this->Html->link(__("Options", true), array('controller'=> 'products', 'action'=>'view_options', $product['Product']['id'], 'admin' => true), array('escape'=>false, 'class'=>'button tiny success'));
							}
						?>
