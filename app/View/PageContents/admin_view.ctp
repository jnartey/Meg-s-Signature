					...
					<tr>
						...
						<td class="actions">
							<?php 
								...
								if($page['PageContent']['page_type'] != 5 && $page['PageContent']['category'] != null){
									if($page['PageContent']['category'] == 1 || $page['PageContent']['category'] == 8 || $page['PageContent']['category'] == 30 || $page['PageContent']['category'] == 19){
										if($page['PageContent']['default'] == 1){
											echo '<span class="button tiny secondary">Default</span>';
										}else{
											echo " ".$this->Form->postLink(__("Set default", true), array('controller'=> 'pageContents', 'action'=>'set_default',  $page['PageContent']['category'], $page['PageContent']['id'], 'admin' => true), array('escape'=>false, 'class'=>'button tiny primary'), sprintf(__('Are you sure you want to set this page as default?', true), $page['PageContent']['id'])); 
										}
									}
								}
								
								if($page['PageContent']['page_type'] == 2 || $page['PageContent']['page_type'] == 9){
									if($page['PageContent']['add_content'] == 0){
										if($page['PageContent']['feature'] == 1){
											echo $this->Form->postLink(__("Featured", true), array('controller'=> 'pageContents', 'action'=>'featured_clear', $page['PageContent']['category'], $page['PageContent']['id'], 'admin' => true), array('escape'=>false, 'class'=>'button tiny success'), sprintf(__('Are you sure you want to feature '.$page['PageContent']['title'].'?', true), $page['PageContent']['id']));
										}else{
											echo $this->Form->postLink(__("Feature", true), array('controller'=> 'pageContents', 'action'=>'featured', $page['PageContent']['category'], $page['PageContent']['id'], 'admin' => true), array('escape'=>false, 'class'=>'button tiny secondary'), sprintf(__('Are you sure you want to feature '.$page['PageContent']['title'].'?', true), $page['PageContent']['id']));
										}
									}
								}
							?>
